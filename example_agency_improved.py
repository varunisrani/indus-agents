...
def create_planner_agent(model: str = "gpt-4o", reasoning_effort: str = "medium") -> Agent:
    """
...
def create_development_agency(
    ...
    """
    Create development agency with intelligent routing.
...
def main():
    """
    Main entry point - improved agency with dynamic routing.
    """
    # Check for API key
    ...
    print("=" * 70)
    print("  INDUS-AGENTS - Improved Multi-Agent System")
    ...
    # Create agency with gpt-5-mini (latest, fastest, best rate limits)
    print("Creating development agency...")
    agency = create_development_agency(
        model="gpt-5-mini",  # ✅ Latest GPT-5 mini (Aug 2025 release)
